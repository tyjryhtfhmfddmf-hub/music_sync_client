...
playlist_box = TkinterDnD.Listbox(root, width=55, height=10)
playlist_box.pack(pady=10)

top_frame = TkinterDnD.Frame(root)
top_frame.pack()

add_btn = TkinterDnD.Button(top_frame, text="Add Files", command=add_songs)
add_folder_btn = TkinterDnD.Button(top_frame, text="Add Folder", command=add_folder)
add_btn.grid(row=0, column=0, padx=5)
add_folder_btn.grid(row=0, column=1, padx=5)

controls_frame = TkinterDnD.Frame(root)
controls_frame.pack(pady=10)
prev_btn = TkinterDnD.Button(controls_frame, text="⏮", command=prev_song)
play_btn = TkinterDnD.Button(controls_frame, text="▶️ / ⏸", command=play_pause_toggle)
next_btn = TkinterDnD.Button(controls_frame, text="⏭", command=next_song)
stop_btn = TkinterDnD.Button(controls_frame, text="⏹", command=stop_song)
prev_btn.grid(row=0, column=0, padx=5)
play_btn.grid(row=0, column=1, padx=5)
next_btn.grid(row=0, column=2, padx=5)
stop_btn.grid(row=0, column=3, padx=5)

bottom_frame = TkinterDnD.Frame(root)
bottom_frame.pack(pady=10)
loop_btn = TkinterDnD.Button(bottom_frame, text="Loop: OFF", command=toggle_loop)
shuffle_btn = TkinterDnD.Button(bottom_frame, text="Shuffle: OFF", command=toggle_shuffle)
loop_btn.grid(row=0, column=0, padx=10)
shuffle_btn.grid(row=0, column=1, padx=10)

network_frame = TkinterDnD.LabelFrame(root, text="Network Sync")
network_frame.pack(pady=10)
host_btn = TkinterDnD.Button(network_frame, text="Host Session", command=host_session)
join_label = TkinterDnD.Label(network_frame, text="Join Code:")
join_entry = TkinterDnD.Entry(network_frame, width=15)
join_btn = TkinterDnD.Button(network_frame, text="Join", command=join_session)
...
status_label = TkinterDnD.Label(root, text="Status: Idle", anchor="w")
